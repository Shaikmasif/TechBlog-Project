<nav class="navbar navbar-expand-lg navbar-dark primary-background">
	...
	<div class="collapse navbar-collapse" id="navbarSupportedContent">
		<ul class="navbar-nav mr-auto">
			...
			<li class="nav-item"><a class="nav-link" href="login_page.jsp"> <span class="fa fa fa-user-circle"></span> Login</a></li>
			<li class="nav-item"><a class="nav-link" href="register_page.jsp"> <span class="fa fa fa-user-plus"></span> Sign Up</a></li>
